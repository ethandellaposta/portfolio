...
export const ExperienceTimelineProject = (props: ProjectProps) => {
  return (
    <div className="flex flex-col space-y-8  bg-white bg-opacity-5  backdrop-blur-sm p-8 pt-5 rounded-md">
      ...
      <div className="flex flex-col lg:flex-row justify-start space-y-8 lg:space-x-8">
        <div className=" w-40 h-40 rounded-md bg-white bg-opacity-10 flex flex-row justify-center items-center aspect-square">
          <img
        ...
        <div className="flex flex-col justify-end items-start space-y-4">
          <div className="bg-white bg-opacity-10 min-h-8 px-4 py-2 flex flex-row justify-center items-center rounded-md">
            <p className="text-white opacity-50">{props.duration}</p>
          </div>
          <div className="bg-white bg-opacity-10 min-h-8 px-4 min-h-8 py-2 flex flex-row justify-center items-center rounded-md">
